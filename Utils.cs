...
namespace Automation_Code_Challenge_7_CSharp
{
    ...
    class Utils : SeleniumWebdriverBaseClass
    {
        ...
        private void verifyPageTitle(String webPageURL, String titleStringToTest)
        {
            ...
            consoleAndOutputFilePrint(automation_code_challenge_7_sw, "Page title of current page is: " + pageTitle);
            // Print title string to test
            consoleAndOutputFilePrint(automation_code_challenge_7_sw, "Title String to Test is: " + titleStringToTest);
            ...
            consoleAndOutputFilePrint(automation_code_challenge_7_sw, "Current Page Title = Expected Page Title");
        }
        ...
        private void subMenuNavigation(String navigationMenu, String navigationSubMenu)
        {
            ...
            else
            {
                ...
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, navigationMenu + " navigation menu does not exist on this page");
            }
        }
        ...
        public void searchForDialog(String whatParameter, String byResortParameter, String subCategoryParameter)
        {
            ...
            if (searchDialogPresent)
            {
                ...
                {
                    consoleAndOutputFilePrint(automation_code_challenge_7_sw, "");
                    consoleAndOutputFilePrint(automation_code_challenge_7_sw, "Search Results");
                    consoleAndOutputFilePrint(automation_code_challenge_7_sw, "");
                }
            ...
            else
            {
                ...
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, "The current page does not contain a Search For dialog box");
            }
        ...
        public void consoleSearchPrint(IReadOnlyCollection<IWebElement> resultList)
        {
            ...
            {
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, resultList.ElementAt(listIndex).Text);
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, "--------------------");
            }
        ...
        public void outputFileSearchPrint(IReadOnlyCollection<IWebElement> resultList)
        {
            for (int listIndex = 0; listIndex < resultList.Count(); listIndex++)
            {
                //automation_code_challenge_7_sw.Write(resultList.ElementAt(listIndex).Text);
                //automation_code_challenge_7_sw.WriteLine();
                //automation_code_challenge_7_sw.Write("--------------------");
                //automation_code_challenge_7_sw.WriteLine();
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, resultList.ElementAt(listIndex).Text);
                //automation_code_challenge_7_sw.WriteLine();
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, "--------------------");
        ...
        public void cleanup()
        {
            automation_code_challenge_7_sw.Close();
            automation_code_challenge_7_webpage_word_list_sw.Close();
            automation_code_challenge_7_total_word_list_sw.Close();
        }
        ...
        {
            {
                ...
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, "WebCrawler Start Time - " + crawlerStartTime);
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, "pagesVisited size = " + pagesVisited.Count);
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, "pagesVisited website = " + (pagesVisited.Count - 1));
                ...
                foreach (String hrefValues in hrefAttributeValues)
                {
                    if (!pagesVisited.Contains(hrefValues) && !pagesToVisit.Contains(hrefValues))
                    {
                        ...
                        consoleAndOutputFilePrint(automation_code_challenge_7_sw, hrefValues);
                    }
                }
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, pagesToVisit.Count + " - pages left to visit");
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, "--------------------");
                ...
                // Go to next page in Pages to visit list
                {
                    ...
                    consoleAndOutputFilePrint(automation_code_challenge_7_sw, "pagesVisited size = " + pagesVisited.Count);
                    consoleAndOutputFilePrint(automation_code_challenge_7_sw, "pagesVisited website = " + pagesVisited[(pagesVisited.Count - 1)]);
                ...
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, pagesVisited.Count.ToString());
                DateTime crawlerEndTime = DateTime.Now;
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, "WebCrawler End Time - " + crawlerEndTime);
                ...
                {
                    consoleAndOutputFilePrint(automation_code_challenge_7_sw, "Total WebCrawler Elapsed Time - " + elapsedCrawlerTimeInHours + " hours" + " " + elapsedCrawlerTimeRemainingMinutes + " minute");
                }
                else
                {
                    consoleAndOutputFilePrint(automation_code_challenge_7_sw, "Total WebCrawler Elapsed Time - " + elapsedCrawlerTimeInHours + " hours" + " " + elapsedCrawlerTimeRemainingMinutes + " minutes");
        ...
        foreach (WebsiteWordsRecord wordsRecordIndex in webpageWordsList)
        {
                ...
                automation_code_challenge_7_webpage_word_list_sw.WriteLine('"' + wordsRecordIndex.getWord() + '"' + ", " + '"' + wordsRecordIndex.getWebsite() + '"' + ", " + '"' + wordsRecordIndex.getOccurrences() + '"');
            }
        }
        ...
        foreach (TotalWordsRecord totalWordsRecordIndex in allWordsList)
        {
                ...
                automation_code_challenge_7_total_word_list_sw.WriteLine('"' + totalWordsRecordIndex.getWord() + '"' + ", " + '"' + totalWordsRecordIndex.getOccurrences() + '"');
            }
        }
