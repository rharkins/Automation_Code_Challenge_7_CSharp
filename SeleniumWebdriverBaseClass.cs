...
namespace Automation_Code_Challenge_7_CSharp
{
    class SeleniumWebdriverBaseClass
    {
        ...
        public StreamWriter automation_code_challenge_7_sw = createOutputFile("C:/test/csharp_automation_code_challenge_7_output.txt");
        public StreamWriter automation_code_challenge_7_webpage_word_list_sw = createOutputFile("C:/test/csharp_automation_code_challenge_7_webpage_word_list.txt");
        public StreamWriter automation_code_challenge_7_total_word_list_sw = createOutputFile("C:/test/csharp_automation_code_challenge_7_total_word_list.txt");
