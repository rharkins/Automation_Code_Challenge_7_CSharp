    ...
    class HomePage : SeleniumWebdriverBaseClass
    {
        private void getResortMileageFromAirport(String resortName)
        {
            ...
            if (String.IsNullOrEmpty(resortName))
            {
                ...
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, "No Resort Name entered");
                // Exit from method
                return;
            }
            ...
            {
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, "Resort Name not found");
            }
            ...
            else
            {
                ...
                // consoleAndOutputFilePrint(automation_code_challenge_7_sw, "Entered Resort Name = " + resortName);
                // Print resortValueName from HashMap
                // consoleAndOutputFilePrint(automation_code_challenge_7_sw, "Resort Value = " + resortValueName);
                ...
                // consoleAndOutputFilePrint(automation_code_challenge_7_sw, resortMileageFromAirport.getAttribute("class"));
                // Print text value of WebElement
                // consoleAndOutputFilePrint(automation_code_challenge_7_sw, resortMileageFromAirport.getText());
                ...
                // Print class value of WebElement
                // consoleAndOutputFilePrint(automation_code_challenge_7_sw, resortMileageFromAirportElement.getAttribute("class"));
                // Print innerHtml value of WebElement
                // consoleAndOutputFilePrint(automation_code_challenge_7_sw, resortMileageFromAirportElement.getAttribute("innerHTML"));
                ...
                consoleAndOutputFilePrint(automation_code_challenge_7_sw, resortValueName + " is " + resortMileage + " miles from the airport");
